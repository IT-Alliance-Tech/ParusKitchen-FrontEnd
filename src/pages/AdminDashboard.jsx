...
const AdminDashboard = () => {
  ...
  // determine role from localStorage (keeps backward compatibility)
  const storedUser = (() => {
    try {
  ...
  return (
    <div className="p-8 bg-gray-50 min-h-screen">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        {/* Create Admin User - visible only to superadmin */}
        {isSuperAdmin && (
          <div
            onClick={() => navigate("/admin/create-admin")}
            className="bg-gradient-to-r from-indigo-500 to-purple-600 text-white p-6 rounded-xl shadow-md text-center cursor-pointer hover:opacity-90 transition"
          >
            <h2 className="text-lg font-semibold mb-2">Create Admin User</h2>
